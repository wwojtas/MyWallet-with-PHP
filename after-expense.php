<?php
	...
	if (isset($_SESSION['e_date_of_expense'])) unset($_SESSION['e_date_of_expense']);
	if (isset($_SESSION['e_payment_method'])) unset($_SESSION['e_payment_method']);
        ...
        <div class="container">
            <div class="row  mt-5 pt-5">
                <div class="col-8 offset-2 col-lg-6 offset-lg-3 text-center mt-5">
                    ...
                    <div class="mt-5">
                        <h1> <a href="addExpense.php"> Dodaj kolejny wydatek </a> </h1>
                    </div>
                    <div class="mt-5">
